                                    ...
                                    <div class="tab-pane pt-3 tab-panel" data-tab="3">
                                        <div class="card" style="width: 100%;">
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <!-- Institution-->
                                                <xsl:if test=".//tei:msIdentifier/tei:repository/text()">
                                                    <li class="list-group-item">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6" style="width: 1.5rem; height: 1.5rem; display: inline-block;">
                                                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0 0 12 9.75c-2.551 0-5.056.2-7.5.582V21M3 21h18M12 6.75h.008v.008H12V6.75Z" />
                                                        </svg>
                                                        &#160;
                                                        <xsl:value-of select=".//tei:msIdentifier/tei:repository/text()"/>
                                                    </li>
                                                </xsl:if>
                                                <!-- Collection-->
                                                <xsl:if test=".//tei:msIdentifier/tei:collection/text()">
                                                    <li class="list-group-item">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6" style="width: 1.5rem; height: 1.5rem; display: inline-block;">
                                                            <path stroke-linecap="round" stroke-linejoin="round" d="M20.25 6.375c0 2.278-3.694 4.125-8.25 4.125S3.75 8.653 3.75 6.375m16.5 0c0-2.278-3.694-4.125-8.25-4.125S3.75 4.097 3.75 6.375m16.5 0v11.25c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125V6.375m16.5 0v3.75m-16.5-3.75v3.75m16.5 0v3.75C20.25 16.153 16.556 18 12 18s-8.25-1.847-8.25-4.125v-3.75m16.5 0c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125" />
                                                        </svg>
                                                        &#160;
                                                        <xsl:value-of select=".//tei:msIdentifier/tei:collection/text()"/>
                                                    </li>
                                                </xsl:if>
                                                <!-- Topics-->
                                                <li class="list-group-item">
