...
<xsl:stylesheet 
    ...
    <xsl:param name="html_title">Letters 1916</xsl:param>
    <xsl:param name="project_logo">images/logo.png</xsl:param>
    <xsl:param name="base_url">https://letters1916static.github.io/letters1916-static/</xsl:param>
    <xsl:param name="data_repo">https://github.com/letters1916static/letters1916-data</xsl:param>
</xsl:stylesheet>